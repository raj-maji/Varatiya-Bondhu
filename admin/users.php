...
<section class="grid">
   ...
   <div class="box">
      ...
      <div class="image-gallery">
         <?php if (!empty($fetch_users['image1'])): ?>
            <img src="../uploaded_images/<?= htmlspecialchars($fetch_users['image1']); ?>" alt="Image 1" class="user-image">
         <?php endif; ?>
         <?php if (!empty($fetch_users['image2'])): ?>
            <img src="../uploaded_images/<?= htmlspecialchars($fetch_users['image2']); ?>" alt="Image 2" class="user-image">
         <?php endif; ?>
      </div>
